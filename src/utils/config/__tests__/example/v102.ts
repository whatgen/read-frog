 ...
 *
 * Delta from v101: Translation Hub keeps provider, language, and prompt choices.
 * Existing profiles inherit provider/language defaults and copy their current
 * page-translation prompt selection once.
 */
